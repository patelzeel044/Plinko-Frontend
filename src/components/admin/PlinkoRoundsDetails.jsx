...
import {
  getPlinkoRoundsByUser,
  setRoundFilter,
  setRoundPage,
} from "../../store/Slices/AdminSlice/adminPlinkoRoundsSlice";

export default function PlinkoRoundsDetail({ userId }) {
  ...
  // Trigger fetch on any filter/page change
  useEffect(() => {
    dispatch(
      getPlinkoRoundsByUser({
        userId,
  ...
  }, [dispatch, userId, page, riskLevel, status, rows, sort, dateFrom, dateTo]);
