// src/components/admin/TransactionsDetail.jsx
...
export default function TransactionsDetail({ userId }) {
  ...
  useEffect(() => {
    dispatch(
      getTransactionsByUser({ userId, page, limit: 20, type, status, sort, dateFrom, dateTo })
    );
  }, [dispatch, userId, page, type, status, sort, dateFrom, dateTo]);
      ...
      <div className="overflow-x-auto bg-gray-900 rounded-lg">
        <table className="min-w-full table-auto">
          <thead className="bg-gray-800">
            <tr>
              {["Transaction ID", "Type", "Amount", "Updated Balance", "Status", "Created At"].map((h) => (
